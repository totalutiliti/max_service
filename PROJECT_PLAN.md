...
- Fases 1 e 3 possuem jornadas persistentes demonstráveis no Docker local; a jornada cliente–profissional da criação do pedido à avaliação também é executada automaticamente pelo navegador no CI.
