...
- A Fase 4 já inclui rede do parceiro, captura pública por link/QR com consentimento, triagem operacional de indicações, fila de ocorrências, moderação manual de profissionais e atividade auditável pesquisável para a Operação.
