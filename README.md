...
- Playwright e Axe percorrem os quatro perfis, suas quatro áreas, o acesso e a versão móvel, verificando WCAG 2.2 AA, teclado, foco, navegação e revogação de sessão; as jornadas transacionais conduzem pela interface tanto o caminho do novo pedido à avaliação quanto o cancelamento, tratamento operacional e retorno do estado final ao cliente; falhas preservam relatório, captura e trace por sete dias no CI.
