...
- Playwright e Axe percorrem os quatro perfis, suas quatro áreas, o acesso e a versão móvel, verificando WCAG 2.2 AA, teclado, foco, navegação e revogação de sessão; uma segunda suíte conduz pela interface a jornada cliente–profissional completa, do novo pedido à avaliação; falhas preservam relatório, captura e trace por sete dias no CI.
