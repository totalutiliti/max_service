...
- Playwright e Axe percorrem os quatro perfis, suas quatro áreas, o acesso e a versão móvel, verificando WCAG 2.2 AA, teclado, foco, navegação e revogação de sessão; as jornadas transacionais conduzem pela interface o caminho do novo pedido à avaliação, o cancelamento com tratamento operacional, a indicação do parceiro até a aprovação para onboarding e o atendimento compartilhado da rede até a resolução e a decisão de uma contestação formal; falhas preservam relatório, captura e trace por sete dias no CI.
