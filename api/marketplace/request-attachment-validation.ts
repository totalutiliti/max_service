...
export const maximumRequestAttachmentBytes = 524_288;
export const maximumRequestAttachmentCount = 3;

export function validateRequestAttachment(originalName: string, contentType: string, bytes: Buffer) {
  if (bytes.length < 8 || bytes.length > maximumRequestAttachmentBytes) {
