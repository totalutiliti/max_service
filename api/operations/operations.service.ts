...
const auditActivityCopy: Record<string, { category: string; title: string; detail: string }> = {
  ...
  "privacy.request_created": { category: "operation", title: "Direito do titular solicitado", detail: "Nova solicitação de privacidade registrada pelo próprio titular." },
  "privacy.request_status_changed": { category: "operation", title: "Solicitação de privacidade atualizada", detail: "Decisão humana justificada e versionada pela Operação." },
  "privacy.export_generated": { category: "operation", title: "Pacote de dados gerado", detail: "Exportação estruturada disponibilizada diretamente ao titular." },
...
const auditEntityPrefix: Record<string, string> = {
  ...
  data_subject_request: "DS",
  data_subject_export_receipt: "PX",
