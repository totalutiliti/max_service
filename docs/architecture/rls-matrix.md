...
- agendamentos, entregas simuladas e eventos de relatório retornam zero linhas aos demais perfis; somente a Operação registra destinatário sintético consentido, e a entrega guarda máscara/hash do contato, agregados e checksum sem acionar provedor;
