...
- ampliar a suíte de RLS, autorização, idempotência e E2E; migrations, isolamento da agenda por papel, conflitos de reserva/bloqueio, rate limit, headers HTTP, CORS e limites de corpo já são testados automaticamente no CI;
